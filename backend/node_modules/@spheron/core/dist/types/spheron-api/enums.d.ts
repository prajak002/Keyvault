...
declare enum AppTypeEnum {
    WEB_APP = "app",
    COMPUTE = "compute"
}
export { ProjectTypeEnum, DeploymentEnvironmentStatusEnum, ProjectStateEnum, NodeVersionEnum, FrameworkEnum, DomainTypeEnum, DomainApplicationTypeEnum, DeploymentStatusEnum, AppTypeEnum, };
